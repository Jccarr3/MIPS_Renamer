...
private:
    ...
    typedef struct{
        vector<uint64_t> free_regs;
        uint32_t head = 0, tail = 0;
        bool h_phase = 0, t_phase = 1;
    }F_List;
	...
	// * Structure includes head, tail, and their phase bits.
    typedef struct{
        bool d_flag = false, complete = false, exception = false, load_violation = false, branch_misprediction = false, 
		set_value_misprediction = false,load_flag = false, store_flag = false, branch_flag = false, amo_flag = false, csr_flag = false;
        uint64_t d_reg_logical = 0, d_reg_physical = 0, pc = 0;
	...
	// 3. checkpointed GBM
	typedef struct{
		vector<uint64_t> RMT_shadow;
		uint32_t FL_head = 0;
		bool FL_h_phase = 0;
		uint64_t gbm_check = 0;
	}b_checks;

	vector<b_checks> Branch_Checkpoints;
	/////////////////////////////////////////////////////////////////////
